...
Goal: give stakeholders a simple way to browse the curated data and see quality status without touching notebooks.
...
2) **Do:** (Optional) Place `validation_report.md` from Day 03 into this lab folder.  
   **Why:** Shows quality status in the app for stakeholders.  
...
4) **Do:** In the app, filter by rights or place and review the row counts.  
   **Why:** Lets stakeholders explore without editing data.  
