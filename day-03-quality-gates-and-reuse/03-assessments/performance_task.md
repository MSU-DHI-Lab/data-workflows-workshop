...
2) Implement a Pandera schema with checks for those risks and validate the dataset.
...
## Submission
- Place your schema (`validation_schema.py`), validation report, and any notes in `05-artifacts/submissions/`.
