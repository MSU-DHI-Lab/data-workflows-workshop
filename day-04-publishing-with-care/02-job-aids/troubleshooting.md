...
3) **Invalid .zenodo.json**  
   - Fix: Validate JSON (a structured text format for storing data); ensure required fields (title, upload_type, description, creators, license, version).

4) **Package missing docs**  
   - Fix: Re-run Lab 01; ensure README, data dictionary, notes on what changed, and checks are present.
...
8) **Colleagues confused by jargon**  
